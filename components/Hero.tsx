        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center text-center">
            <div className="inline-block px-4 py-1 rounded-full border border-brand-teal/30 text-brand-teal text-sm font-semibold mb-6 uppercase tracking-wider">
              EBOOK DE MARKETING ESTRATÉGICO
            </div>
            ...
            <p className="text-gray-300 text-lg md:text-xl mb-8 leading-relaxed max-w-xl mx-auto">
            ...
            <div className="mb-8 p-6 bg-white/5 rounded-2xl border border-white/10 inline-block w-full max-w-md text-center">
          ...
          <div className="w-full md:w-1/2 flex justify-center relative">
            <div className="relative w-full max-w-md aspect-[3/4] bg-white/5 border border-white/10 rounded-2xl shadow-2xl overflow-hidden group">
               {/* Mockup Placeholder */}
               <img 
                 src="https://lh3.googleusercontent.com/d/11uY10q_wKasfYXCDCP0c4HEd6xxqdhbg" 
